...
export class ContractOpcodes {
  ...
  static POOLV3_SET_FEE: number = 0xeee16f7d; // 4007751549
  ...
  static POSITIONNFTV3_BURN: number = 0x55521d04; // 1431444740
...
export const OpcodesLookup = {
  ...
  0x55521d04: 'POOLV3_BURN,POSITIONNFTV3_BURN',
...
export class ContractErrors {
  ...
  static POOLV3_FORGED_NFT: number = 105; // 0x69
...
export const ErrorsLookup = {
  ...
  105: 'POOLV3_TOO_MUCH_LIQUIDITY,POOLV3_FORGED_NFT',
