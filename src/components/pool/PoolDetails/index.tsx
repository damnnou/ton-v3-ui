...
export const PoolDetails = ({ pool }: { pool: Pool }) => {
    return (
        <div className="flex w-1/3 flex-col gap-4 bg-light max-sm:p-2 rounded-3xl p-[18px] text-lg">
            <div className="flex flex-col gap-2 items-start bg-dark rounded-2xl p-4">
