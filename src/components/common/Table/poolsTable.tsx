...
const PoolsTable = <TData, TValue>({
    ...
    return (
        <>
                ...
                <div className="flex gap-4 w-full justify-between items-center p-4 pb-0">
                    <div className="flex items-center relative w-fit">
                        <Input
                            ...
                            className="border border-border-light pl-12 h-12 max-w-80 md:w-64 lg:w-80 focus:border-opacity-100 rounded-xl"
                        />
                        <Search className="absolute left-4 text-border" size={20} />
                    </div>
                    <ul className="flex gap-1 p-1 border rounded-xl border-border-light w-fit h-12 max-xs:hidden">
                        <li>
                            <Button
                    ...
                    <div className="flex gap-2 max-md:gap-4 items-center w-fit ml-auto max-sm:hidden"></div>
            ...
            <Table>
                <TableHeader className="[&_tr]:border-b [&_tr]:border-border-light border-t border-border-light">
                ...
                <TableBody className="hover:bg-transparent text-[16px]">
                    {!table.getRowModel().rows.length ? (
                        <TableRow className="hover:bg-light h-full border-border-light">
                        ...
                        table.getRowModel().rows.map((row: any) => {
                            return (
                                <TableRow
                                    ...
                                    className="border-border-light bg-dark hover:bg-border-light cursor-pointer"
                                    onClick={() => {
                                        if (action) {
